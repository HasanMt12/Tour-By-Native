...
const ServiceDetails = () => {
	...
	<div className="container grid gap-6 mx-auto lg:grid-cols-2 xl:grid-cols-5">
		<div className="object-cover w-full rounded-md xl:col-span-3 bg-gray-500">
	<div className="flex flex-col max-w-3xl mx-auto overflow-hidden rounded">
		<img src={picture} alt="" className="w-9/12 mx-auto h-60 sm:h-96 bg-gray-500" />
		<div className="p-6 pb-12 m-4 mx-auto -mt-16 space-y-6 lg:max-w-2xl sm:px-10 sm:mx-12 lg:rounded-md bg-gray-900">
			<div className="space-y-2">
				...
				<div className="flex flex-wrap justify-between pt-3 font-semibold space-x-2 text-xs text-sky-400">
						<span> $ {price}</span>
        ...
        <div className="w-full  rounded-md sm:px-12 md:px-16 xl:col-span-2 bg-gray-900">	
